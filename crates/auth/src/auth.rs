...
pub fn create_token(params: TokenParams) -> Result<String, jsonwebtoken::errors::Error> {
    let now = Utc::now().timestamp() as usize;

    let token_type: String = match params.token_type {
    ...
    let default_duration = if token_type == "refresh" {
